...
router.get('/createComunicacionRender', authMiddleware([1, 2, 5]) , colegioController.createComunicacionRender);
router.post('/createComunicacion', colegioController.createComunicacion);

router.get('/renderComunicacion', authMiddleware([1, 2, 5]) , colegioController.renderComunicacion);

router.get('/calendario', authMiddleware([1, 2, 5]) , colegioController.renderCalendario);
