...
router.get('/inicio', authMiddleware([1, 2, 3, 4, 5]) , userController.inicio);
...
//Mi perfil
router.get('/perfil', authMiddleware([1, 2, 3, 5]), userController.mostrarPerfil);

router.get('/renderEditarPerfil', authMiddleware([1, 2, 3, 5]), userController.renderEditarPerfil);
router.post('/editar_perfil/:id', authMiddleware([1, 2, 3, 5]) , userController.editarPerfil);
